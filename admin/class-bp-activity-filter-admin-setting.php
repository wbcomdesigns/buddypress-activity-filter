								...
								?>
										...
										<tr>
											...
											<td class="filter-option" data-title="Upload Label">
												<input id="<?php echo esc_attr($post_type . '_text'); ?>" placeholder='<?php echo strtolower(esc_html($post_details->label)); ?>' name='<?php echo esc_attr("bpaf_admin_settings[$post_type][new_label]"); ?>' type="text" value="<?php echo esc_attr($value); ?>" />
											</td>
										</tr>
