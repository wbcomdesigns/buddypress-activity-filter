...
if ( ! class_exists( 'Wbcom_Admin_Settings' ) ) {
	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_enqueue_admin_scripts() {
			...
			if ( ! wp_script_is( 'wbcom_admin_setting_js', 'enqueued' ) ) {
				...
				wp_register_script(
					...
					BP_ACTIVITY_FILTER_PLUGIN_URL . 'admin/wbcom/assets/js/wbcom-admin-setting.js',
					array( 'jquery' ),
					time(),
					false
				);
		...
		public function wbcom_admin_additional_pages() {
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Our Plugins', 'bp-activity-filter' ),
				esc_html__( 'Our Plugins', 'bp-activity-filter' ),
				'manage_options',
				'wbcom-plugins-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Our Themes', 'bp-activity-filter' ),
				esc_html__( 'Themes', 'bp-activity-filter' ),
				'manage_options',
				'wbcom-themes-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Our Support', 'bp-activity-filter' ),
				esc_html__( 'Support', 'bp-activity-filter' ),
				'manage_options',
				'wbcom-support-page',
		...
		public function wbcom_admin_setting_header_html() {
			...
			<div id="wb_admin_header" class="wp-clearfix">
				...
				<div id="wb_admin_logo">
					<img src="<?php echo esc_url( BP_ACTIVITY_FILTER_PLUGIN_URL ) . 'admin/wbcom/assets/imgs/logowbcom.png'; ?>">
