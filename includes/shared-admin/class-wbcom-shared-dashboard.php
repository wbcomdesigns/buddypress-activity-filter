 ...
 *
 * Universal dashboard for all Wbcom Designs plugins.
 */
class Wbcom_Shared_Dashboard {
	...
	/**
	 * Whether the admin menu has been created.
	 *
	 * @var bool
	 */
				...
				<div class="wbcom-welcome-panel-column">
					...
					<div class="wbcom-system-status" style="display: flex; flex-direction: column; gap: 12px;">
						...
						<div style="display: flex; align-items: center; gap: 12px; padding: 12px; background: #f8f9fa; border-radius: 8px;">
							...
							<span style="font-size: 13px; color: #515b67; margin-left: auto;"><?php echo function_exists( 'buddypress' ) ? esc_html__( 'Active', 'bp-activity-filter' ) : esc_html__( 'Inactive', 'bp-activity-filter' ); ?></span>
						</div>
						<div style="display: flex; align-items: center; gap: 12px; padding: 12px; background: #f8f9fa; border-radius: 8px;">
							...
							<span style="font-size: 13px; color: #515b67; margin-left: auto;"><?php echo defined( 'WP_DEBUG' ) && WP_DEBUG ? esc_html__( 'Debug On', 'bp-activity-filter' ) : esc_html__( 'Active', 'bp-activity-filter' ); ?></span>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="wbcom-plugin-card plugin-status-<?php echo esc_attr( $plugin['status'] ); ?>">
						...
						<div class="plugin-card-bottom">
							<div class="plugin-actions">
								<?php if ( 'active' === $plugin['status'] && ! empty( $plugin['settings_url'] ) ) : ?>
	 ...
	 *
	 * @return array Dashboard stats including plugin counts and versions.
	 */
	...
	/**
	 * Get active plugins from the registered list.
	 *
	...
	/**
	 * Extract menu slug from a settings URL.
	 *
	 * @param string $settings_url The settings page URL.
	...
	/**
	 * Render admin notices for the dashboard.
	 */
	...
	/**
	 * Get the list of premium plugins for the dashboard.
	 *
	 * @return array List of premium plugin data.
	 */
	...
	/**
	 * Get the list of premium themes for the dashboard.
	 *
	 * @return array List of premium theme data.
	 */
