...
$bpaf_ecosystem = array(
	array(
		'name' => __( 'BuddyX', 'bp-activity-filter' ),
		'logo' => 'buddyx.png',
	...
	array(
		'name' => __( 'BuddyNext', 'bp-activity-filter' ),
		'logo' => 'buddynext.svg',
		'icon' => 'groups',
	...
	array(
		'name' => __( 'Jetonomy', 'bp-activity-filter' ),
		'logo' => 'jetonomy.svg',
		'icon' => 'format-chat',
	...
	array(
		'name' => __( 'Mediaverse', 'bp-activity-filter' ),
		'logo' => 'mediaverse.svg',
		'icon' => 'format-gallery',
	...
	array(
		'name' => __( 'Eventonomy', 'bp-activity-filter' ),
		'logo' => 'eventonomy.svg',
		'icon' => 'calendar-alt',
	...
	array(
		'name' => __( 'WB Gamification', 'bp-activity-filter' ),
	...
	array(
		'name' => __( 'Listora', 'bp-activity-filter' ),
		'logo' => 'listora.svg',
		'icon' => 'list-view',
	...
	array(
		'name' => __( 'WP Career Board', 'bp-activity-filter' ),
	...
	array(
		'name' => __( 'Learnomy', 'bp-activity-filter' ),
		'logo' => 'learnomy.svg',
