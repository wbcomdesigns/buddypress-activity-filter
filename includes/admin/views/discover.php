...
$bpaf_ecosystem = array(
	array(
		...
		'desc' => __( 'A free, fast community theme for BuddyPress, BuddyBoss and PeepSo with a modern layout and dark mode.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'logo' => 'buddynext.svg',
		'icon' => 'groups',
		'desc' => __( 'The full community stack: activity feeds, member spaces, profiles, and private messaging on WordPress.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'logo' => 'jetonomy.svg',
		'icon' => 'format-chat',
		'desc' => __( 'Self-moderating forums and Q&A boards that stay fast well beyond 100,000 topics.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'logo' => 'mediaverse.svg',
		'icon' => 'format-gallery',
		'desc' => __( 'A photo and video hub with albums, reactions, following, and private chat.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'logo' => 'eventonomy.svg',
		'icon' => 'calendar-alt',
		'desc' => __( 'Run community events with RSVPs, calendars, and front-end submissions.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'icon' => 'awards',
		'desc' => __( 'Reward members with points, badges, and leaderboards to keep engagement high.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'logo' => 'listora.svg',
		'icon' => 'list-view',
		'desc' => __( 'Searchable directories with ten listing types, ratings, maps, and front-end submissions.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'icon' => 'businessman',
		'desc' => __( 'Add a job board with front-end listings, applications, and employer profiles.', 'buddypress-activity-filter' ),
	...
	array(
		...
		'desc' => __( 'Create, sell, and auto-grade online courses, then hand out certificates automatically.', 'buddypress-activity-filter' ),
...
<div class="bpaf-card">
	<div class="bpaf-card__head">
		<p class="bpaf-card__title"><?php esc_html_e( 'More Free Tools from Wbcom Designs', 'buddypress-activity-filter' ); ?></p>
		<p class="bpaf-card__desc"><?php esc_html_e( 'Activity Filter keeps your BuddyPress stream focused. These free tools from Wbcom Designs build out the community around that stream: the theme and network itself, forums, media, events, gamification, directories, jobs, and courses.', 'buddypress-activity-filter' ); ?></p>
	</div>
			...
			<?php foreach ( $bpaf_ecosystem as $bpaf_product ) : ?>
				<div class="bpaf-discover-card">
					...
					<a class="bpaf-btn bpaf-btn-secondary bpaf-discover-card__cta" href="<?php echo esc_url( $bpaf_product['url'] ); ?>" target="_blank" rel="noopener">
						<?php esc_html_e( 'Get it free', 'buddypress-activity-filter' ); ?>
						<span class="dashicons dashicons-external" aria-hidden="true"></span>
						<span class="screen-reader-text">
							<?php
							/* translators: %s: product name. */
							echo esc_html( sprintf( __( '%s (opens in a new tab)', 'buddypress-activity-filter' ), $bpaf_product['name'] ) );
							?>
						</span>
					</a>
				</div>
